...
//					'cabin' => 'Cabin:400,400italic,600,700',
...
//			wp_enqueue_style( 'cabin', '//fonts.googleapis.com/css?family=Cabin:400,400italic,600,700' );
			wp_enqueue_style( 'pt-serif', '//fonts.googleapis.com/css?family=PT+Serif:400,700' );
